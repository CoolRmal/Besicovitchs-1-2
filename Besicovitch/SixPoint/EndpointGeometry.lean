...
def rootDisplacement (configuration : SixPointConfiguration E) : E :=
  configuration .blue .root - configuration .red .root

/-- A red point, translated relative to the red root. -/
def redDisplacement (configuration : SixPointConfiguration E) (label : SixPointLabel) :
    E :=
  configuration .red label - configuration .red .root

/-- A blue point pulled back from the blue root into the red child ball. -/
def bluePullback (configuration : SixPointConfiguration E) (label : SixPointLabel) :
    E :=
  configuration .blue .root - configuration .blue label

/-- The root displacement of an admissible configuration has unit norm. -/
theorem norm_rootDisplacement {configuration : SixPointConfiguration E} {s : ℝ}
...
theorem norm_redDisplacement_le_one {configuration : SixPointConfiguration E} {s : ℝ}
...
theorem norm_bluePullback_le_one {configuration : SixPointConfiguration E} {s : ℝ}
    (h : configuration.IsAdmissibleAt s) {label : SixPointLabel} (hlabel : label ≠ .root) :
...
theorem dist_redDisplacement (configuration : SixPointConfiguration E)
...
theorem dist_bluePullback (configuration : SixPointConfiguration E)
    (label₁ label₂ : SixPointLabel) :
...
theorem two_mul_le_dist_redDisplacement {configuration : SixPointConfiguration E} {s : ℝ}
...
theorem two_mul_le_dist_bluePullback {configuration : SixPointConfiguration E} {s : ℝ}
    (h : configuration.IsAdmissibleAt s) :
...
theorem dist_red_blue_eq_norm (configuration : SixPointConfiguration E)
